...
# MariaDB is accessed through Django's MySQL backend.

DATABASES = {
"default": {
"ENGINE": "django.db.backends.mysql",
"NAME": os.getenv("DB_NAME", "news_project"),
...
DEFAULT_FROM_EMAIL = "[newshub@example.com](mailto:newshub@example.com)"
